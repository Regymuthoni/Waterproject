...
void loop() {
 ...
 Calc = (FlowPulse * 30 / 7.5); //(Pulse frequency x 30) / 7.5Q, = flow rate in L/hour 
 Serial.print (Calc, DEC); //Prints the number calculated above
 Serial.print (" ml/second/r/n"); //Prints "L/hour" and returns a  new line
